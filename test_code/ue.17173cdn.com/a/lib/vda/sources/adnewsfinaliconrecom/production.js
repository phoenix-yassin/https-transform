    ...
    this.html.push('<div class="gb-final-comm-case gb-final-pn-star-col">',
      ...
      for(var i = 0 ; i<opt.ads.length; i++) {
         this.html.push('<li class="gb-final-list2-item">',
                  '<a class="gb-final-list2-con" href="',opt.ads[i].link,'" target="_blank"><span class="gb-final-list2-c1"><img class="gb-final-avatar" alt="" src="',opt.ads[i].source,'" width="',opt.ads[i].width,'" height="',opt.ads[i].height,'"> </span><span class="gb-final-list2-c2"><span class="gb-final-txt">',opt.ads[i].title1,'</span></span> </a></li>');
