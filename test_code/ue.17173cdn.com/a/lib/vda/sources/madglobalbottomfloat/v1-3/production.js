(function() {
  adv.AdMBase.extend('MadGlobalBottomFloat', {
    ...
    _getData: function(callback) {
      ...
      var opt = self.options;
      $.ajax({
        url: advConfigs.API_ADDRESSS.alllget,
        type: 'get',
        dataType: 'jsonp',
        data: {
    ...
    _floatUp: function() {
      ...
      var opt = self.options;
      adv.util.poll(function() {
        return $('.opera-pn').length;
      },function() {
        $('.'+opt.advid).css({'bottom': $('.opera-pn').height()+'px'});
      },function() {
      },3000,100);
    },
    init: function (options) {
      ...
      if (typeof jQuery == 'undefined') {
        ...
        script.src = 'http://ue.17173cdn.com/a/lib/jquery-2.1.1.min.js';
        script.id = 'madjQuery';
