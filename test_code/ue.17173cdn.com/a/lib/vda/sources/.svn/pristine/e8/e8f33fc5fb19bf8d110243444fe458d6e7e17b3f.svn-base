    ...
    render: function() {
        ...
        setTimeout(function() {
            var str = '<div class="m-ad-2" id="adStart" style="background-image:url(' + b.btnimg + ')"><a class="u-tga">重播</a></div>' +
                ...
                '</a></div><a id="adClose" style="z-index:9999;background:url(http://ue.shouyoucdn.com/a/index/2016/images/close_banner_swf.jpg) no-repeat;position:absolute;top:0;right:0;width:66px;display:block;height:18px;">关闭</a></div>';
