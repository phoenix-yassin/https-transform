adv.AdBase.extend('AdNewsIndexBanner', {
  ...
  play: function () {
    this.base();
     ...
     if(this.options.src){
        ...
        $('.' + this.options.advid).css({'*zoom':1, 'padding': 0, margin: '10px 0'});
        if(this.options.advid == 'adnewsindexbanner2' || this.options.advid == 'adnewsindexbanner3'  || this.options.advid == 'adnewsindexbanner4' ) {
          $('.' + this.options.advid).css({'padding': 0, margin: '10px 0'});
        }
