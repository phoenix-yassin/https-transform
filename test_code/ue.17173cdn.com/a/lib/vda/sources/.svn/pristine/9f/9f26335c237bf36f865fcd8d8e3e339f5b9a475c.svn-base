...
adv.AdBase.extend('AdFlashIndexDoubleFloat', {
  ...
  setup: function() {
    ...
    '<span  style="position:absolute; bottom:0; left:0; width:12px; height:12px ; z-index:100; cursor:pointer; background:#fff; opacity:0; filter:alpha(opacity=0)" class="doublefloatclose" ></span>'+
    '<a href="'+this.options.datas.left.url+'" target = "_blank" style="position:absolute; left:0; top:0; z-index:-1; width:100%; height:100%">'+
    '<img src = "'+this.options.datas.left.src+'" width = "'+this.options.datas.left.width+'" height = "'+this.options.datas.left.height+'">'+
    '</a></div>'+
    ...
    '<img src = "'+this.options.datas.right.src+'" width = "'+this.options.datas.right.width+'" height = "'+this.options.datas.right.height+'"></a>'+
    '<a href="javascript:;" style="position:absolute; bottom:0; right:0; width:12px; height:12px ; z-index:10; background:#fff; opacity:0; filter:alpha(opacity=0)" class="doublefloatclose" ></a></div>'+
