adv.AdBase.extend('AdRightTopWindow', {
  init: function (options) {
    this.base(options);
    //声明广告在页面9宫格中所处位置,用于广告冲突管理.
    this.position = adv.ENUM.POSITION.topRight;
    //在适当的时候触发初始化完成的事件
  ...
  setup: function () {
    ...
    this.html = [];
    this.html.push('<div style="position:absolute;top:0;right:0;width:400px;height:200px;">');
