...
(function(){
  ...
  setup: function(data) {
    ...
    play: function() {
      ...
      if(!me.getCookie('randomNum5')  ) {
        me.setCookie('randomNum5', me.isRamdom(), me.data.expiryDate);
      }

      // me.setCookie('randomNum5', 1, me.data.expiryDate);


      if( ( me.getCookie('randomNum5') && me.getCookie('randomNum5') == 1 ) || (!me.getCookie('randomNum5') && me.isRamdom() == 1  )  ) {
