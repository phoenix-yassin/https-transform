...
function dbSelect(val){switch(val){case"wow":document.frmWOWSEARCHBOX.action="//

wow.db.17173.com/Search.aspx";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="KVAL";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"tl":document.frmWOWSEARCHBOX.action="//

tl.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="str";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"aion":document.frmWOWSEARCHBOX.action="//

aion.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"jx3":document.frmWOWSEARCHBOX.action="//

jx3.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"dnf":document.frmWOWSEARCHBOX.action="//

dnf.db.17173.com/equips.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="name";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"sg2":document.frmWOWSEARCHBOX.action="//

sg2.db.17173.com/search.html";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="search";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"luna":document.frmWOWSEARCHBOX.action="//

luna.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"wof":document.frmWOWSEARCHBOX.action="//

wof.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"pk1937":document.frmWOWSEARCHBOX.action="//

gdb.17173.com/jsp/gamedb/searchNew.jsp";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="varValue";document.frmWOWSEARCHBOX.gameCode.value="10053";document.frmWOWSEARCHBOX.classStr.value="0,3,4,5,6,1,7";document.frmWOWSEARCHBOX.varName.value="RecordName";break;case"loong":document.frmWOWSEARCHBOX.action="//

loong.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"dn":document.frmWOWSEARCHBOX.action="//

dn.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"yzol":document.frmWOWSEARCHBOX.action="//

yzol.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"qn":document.frmWOWSEARCHBOX.action="//

qn.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"lol":document.frmWOWSEARCHBOX.action="//

lol.db.17173.com/index.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break;case"ldj":document.frmWOWSEARCHBOX.action="//

ldj.db.17173.com/search.php";document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].name="key";document.frmWOWSEARCHBOX.gameCode.value="";document.frmWOWSEARCHBOX.classStr.value="";document.frmWOWSEARCHBOX.varName.value="";break}}function dbSubmit(){if(document.frmWOWSEARCHBOX.getElementsByTagName('input')[0].value=='\u8bf7\u8f93\u5165\u641c\u7d22\u5185\u5bb9\u5173\u952e\u5b57'){document.frmWOWSEARCHBOX.getElementsByTagName('input')[0].value=''}if(document.frmWOWSEARCHBOX.getElementsByTagName('select')[0].value=='sg2'){window.open("//

sg2.db.17173.com/search.html?count=20&search="+escape(document.frmWOWSEARCHBOX.getElementsByTagName("input")[0].value))}else if(document.frmWOWSEARCHBOX.getElementsByTagName('select')[0].value=='wow'){window.open("//

wow.db.17173.com/")}else{document.frmWOWSEARCHBOX.method="post";document.frmWOWSEARCHBOX.submit()}}
...
GGfocusCover.prototype={
  ...
  fillSwf:function(){
    ...
    this.sohuFlashFocover=new sohuFlash("//

www.17173.com/adoshell3.swf","focus_ad","365","475","8","#ffffff");
