...
(function(){
  ...
  this.css = '<style type="text/css" media="screen">\
    ...
    #tg_hao_zqtop .tg-hao-zqtop-gift,#tg_hao_zqtop .tg-hao-zqtop-dl{ display: block; width:144px; height: 44px; margin:-15px -10px 0 -10px; white-space:nowrap;  padding:20px 20px 10px 70px; background: url(//

ue.17173cdn.com/a/module/hao/2016/img/tg-hao-zqtop.png) no-repeat; box-sizing:content-box;overflow:hidden;}\
