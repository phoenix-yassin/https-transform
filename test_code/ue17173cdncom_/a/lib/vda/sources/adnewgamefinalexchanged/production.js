...
newgame.17173.com/game-info-'+gameData.game_code+'.html" target="_blank" class="btn-c1">进入专区</a>'+
                  '<a href="//

hao.17173.com/sche-info-'+gameData.game_code+'.html" target="_blank" class="btn-c2">礼包领取</a>'+
                '</div>'+
...
test.newgame.17173.com/api-gameDetailInfoJs-'+data.gameCode+'.html?callback=?',
        type: 'GET',
        dataType: 'jsonp',
    ...
    '.fix-sameip-close{position:absolute;top:-10px;right:-10px;z-index:10;width:25px;height:25px;background:url(//

ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat 0 0}'+
    ...
    '.fix-sameip-c2{position:absolute;z-index:11;top:0;right:0;display:none;padding:5px 7px 35px;width:1pc;background:#ffcd00 url(//

ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat -60px bottom;color:#333;font-family:"Microsoft YaHei";line-height:1.3;cursor:pointer}';
    ...
    if($(window).width() >( parseInt($('.content').width(),10) + 170) ) {
      ...
      '.fix-sameip-c1{padding-top:29px;background: url(//

ue3.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-bg.png) no-repeat 2px top;}</style>';
    } else {
