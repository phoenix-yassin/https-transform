...
ue1.17173.itc.cn/a/www/index/2013/images/close.gif" /></a>'), this.html = adv.$('<div id="moneyQiYu" class="money-qiyu ' + this.options.advid + '" style="position: fixed; /*width:180px;height:320px;*/top: 80px;z-index:1010;"></div>'), this.bigWrapEl = adv.$('<div class="big-box"></div>'), this.smallWrapEl = adv.$('<div class="small-box" style="display:none;position: fixed;width:30px;height:35px;top: 80px;z-index:1010;"></div>'), this.bigWrapEl.append(this.closeEl), t.height = t.height || "auto", t.width = t.width || "auto", i = t.bigImg.indexOf(".swf") >= 0 ? adv.flash.embed({
    ...
    showAdMark:function(){
      $('#moneyQiYu .close img').attr('src','//

ue.17173cdn.com/a/lib/vda/sources/adglobalmoneyqiyu/v1-1/close_ad.png');
    },
