...
function isMobile() {
 ...
 jQuery('wrapper').hide()
  ...
  setup: function(data) {
    ...
    me.html = '<div class="gb-tg-b">\
          ...
          <div class="gb-tg-b-con">\
            ...
            <a href="javascript:;" class="gb-tg-close"></a>\
        </div>\
        <div class="gb-tg-l">\
          <a href="javascript:;"  class="gb-tg-l-con" >\
    ...
    this.css = '<style>.gb-tg-b{width: 100%; height: 130px; position: fixed;  left: 0; bottom: 0; z-index: 100;}' +
      ...
      '.gb-tg-b .gb-tg-close{width:30px; height: 30px; background:#000 url(http://ue.17173cdn.com/a/module/zq/2016/tuiguang/img/ico-tg-close.gif) no-repeat center center; border: 1px solid #848484; border-radius: 50%;position: absolute; left: 50%; margin-left: 500px; top: 5px; z-index: 9}' +
      '.gb-tg-l{width:154px; z-index: 100; display:none; height: 120px; background: url(http://ue.17173cdn.com/a/module/zq/2016/tuiguang/img/bg-tg.png) no-repeat; position:fixed; left: 0;  bottom: 0;}' +
  ...
  play: function() {
    ...
    // 下载站
    if(keyword!='0')  {
       if( location.href.indexOf('download.17173.com') != -1 && location.href !=="http://download.17173.com/"  && me.data.gameCode == _gameCode) {
          var h1  =  $('h1').text();
        ...
        if(location.host == 'hao.17173.com') {
          var gameName = haoConfig.gameName || $('h2 .orange').eq(0).text();
          var gameCode = haoConfig.gameCode;
          if(gameName == keyword || me.data.gameCode == gameCode) {
             $('head').append(me.css);
            me.showHtml();
