...
adv.AdBase.extend('AdYeyouFocusCoverUp', {
  ...
  _gemFocusSide: function() {
    var html;
    var left = this.el.offset().left - 170,
        top = this.el.offset().top || 0;
    html = $('<a target="_blank" style="position:absolute; left:'+left+'px; top:'+top+'px; z-index:999; width:160px; height:260px; display:block; overflow:hidden;" class="component-focus-cover-side" href="'+ this._coverConfig.link +'" ><img src="'+ this._coverConfig.focus.side +'" style="width:100%;height:100%;" /></a>');
...
//    this._gemTabPanel();
  ...
  _resetPosition: function() {
    var self = this;
    var left = self.el.offset().left - 170,
        top = this.el.offset().top || 0;
