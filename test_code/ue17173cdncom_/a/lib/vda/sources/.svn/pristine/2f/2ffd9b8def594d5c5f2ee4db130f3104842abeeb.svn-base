!function(e) {
    adv.AdBase.extend("AdNewsFinalMod", {
      ...
      showRank: function(){
        var me = this;
        $.getScript('http://d1.17173.itc.cn/game-top/info/js/'+me.data.gameCode+'.js?', function() {
      ...
      showScore: function() {
        var me = this;
        $.getScript('http://d1.17173.itc.cn/newgame/Info/js/'+me.data.gameCode+'.js', function() {
