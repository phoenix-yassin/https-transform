...
(function(){
  ...
  this.css = '<style type="text/css" media="screen">\
    ...
    #tg_hao_zqtop .tg-hao-zqtop-gift,#tg_hao_zqtop .tg-hao-zqtop-dl{ display: block; width:144px; height: 44px; margin:-15px -10px 0 -10px; white-space:nowrap;  padding:20px 20px 10px 70px; background: url(http://ue.17173cdn.com/a/module/hao/2016/img/tg-hao-zqtop.png) no-repeat; box-sizing:content-box;overflow:hidden;}\
  ...
  showButton:function(url,url1) {
   ...
   play: function() {
      ...
      if(me.data.prizeId) {
        var url ="http://d1.17173.itc.cn/hao/giftinfo/js/"+me.data.prizeId+".js"
      } else {
        var url = "http://d1.17173.itc.cn/hao/giftlist/js/"+gameCode+".js"; 
      }

     var  url1 = 'http://d1.17173.itc.cn/download/game/js/'+gameCode+'.js';
