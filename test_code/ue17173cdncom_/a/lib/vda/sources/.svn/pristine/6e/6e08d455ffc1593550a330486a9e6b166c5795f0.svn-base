	...
	setup: function() {
		...
		var t = this.options,
			i = "",
			e = "",
			o = "position: absolute;bottom: 0;left: 0; top:auto; background: #fff;color: #000;font-weight: bold;text-decoration: none;padding:0;margin:0;line-height:13px; width: 13px; height:13px";
		this.closeEl = adv.$('<a class="close" href="javascript://" style="' + o + '"><img src="http://ue1.17173.itc.cn/a/www/index/2013/images/close.gif" /></a>'), this.html = adv.$('<div id="moneyQiYu" class="money-qiyu ' + this.options.advid + '" style="position: fixed; /*width:180px;height:320px;*/top: 80px;z-index:1010;"></div>'), this.bigWrapEl = adv.$('<div class="big-box"></div>'), this.smallWrapEl = adv.$('<div class="small-box" style="display:none;position: fixed;width:30px;height:35px;top: 80px;z-index:1010;"></div>'), this.bigWrapEl.append(this.closeEl), t.height = t.height || "auto", t.width = t.width || "auto", i = t.bigImg.indexOf(".swf") >= 0 ? adv.flash.embed({
			source: t.bigImg,
			width: t.width,
			height: t.height,
			params: {
	...
	_getLeft: function() {
		var t = this,
			i = this.options,
			e = t._getWindowWidth();
		return window.contentWidthAdGlobalMoneyQiYu1 && (i.contentWidth = window.contentWidthAdGlobalMoneyQiYu1), i.contentWidth + Math.floor((e - i.contentWidth) / 2) + 10
	},
    showAdMark:function(){
      $('#moneyQiYu .close img').attr('src','http://ue.17173cdn.com/a/lib/vda/sources/adglobalmoneyqiyu/v1-1/close_ad.png');
    },
	...
	play: function() {
		...
		this.base(), adv.$("body").append(e), e.css({
			left: t._getLeft()
		});
