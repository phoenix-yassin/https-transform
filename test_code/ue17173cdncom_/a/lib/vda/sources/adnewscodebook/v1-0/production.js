!function(e) {
    ...
    adv.AdBase.extend("AdNewsCodeBook", {
        ...
        setup: function(data) {
          ...
          .busin .busin-c2 .busin-btn-order{display: block;background:url(//

ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/btn1.gif) top center no-repeat ;        box-shadow: 2px 2px 2px 1px #e7c49f; width: 140px;height: 52px;line-height: 52px;color:#fff;font-size: 20px;-webkit-border-radius: 3px;border-radius: 3px;margin:17px auto;}\
          ...
          .busin-ng-ptlist .busin-cover{position: absolute;width: 70px;height: 52px;top: 0;left: 0;background: url(//

ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-cover.png) no-repeat;_display:none;}\
          ...
          .busin .busin-ng-ico-clock{display: inline-block;*zoom:1;*display: inline;vertical-align: middle;background: url(//

ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-ico.png) no-repeat;width: 23px;height: 23px;margin-right:10px;}\
