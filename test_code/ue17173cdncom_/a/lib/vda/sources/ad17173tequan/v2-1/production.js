      ...
      var tmpl = function() {/*@preserve
        <li class="item item-ex">
          <a href="@link" target="_blank" class="con">
            ...
            <span class="btn-tq"><span class="t1">@btnText1</span><span class="t2">@btnText2</span></span>
          </a>
        </li>
      */};
      this.data.advid = this.options.advid;
      this.data.btnText1 = this.data.btnText1||'特权';
      this.data.btnText2 = this.data.btnText2||'GO';
