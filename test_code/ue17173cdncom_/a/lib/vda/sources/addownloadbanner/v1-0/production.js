...
open.17173.com/proxy/ad.php?v=1&loc_id=823_27822f4cbae6337ab923316cc5f7fec0&data_type=json&proxyurl='+encodeURIComponent('//

ac.o2.qq.com/php/show.php'),function(data){
        if(!data.error){
          me.o2Option = data;
