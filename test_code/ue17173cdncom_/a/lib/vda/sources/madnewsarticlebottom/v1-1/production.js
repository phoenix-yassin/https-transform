    ...
    setup: function () {
      ...
      if (opt.ads.length > 0) {
        ...
        opt.cssString = '.tg-final-banner{ position: relative; margin-bottom: 1px;}\
          ...
          .tg-final-banner .tg-rate,.tg-final-banner .tg-rate-in{ overflow: hidden; height: 12px; background: url(//

ue1.17173cdn.com/a/module/m/gb/2015/img/ico-star.png) no-repeat; background-size: 69px;}\
