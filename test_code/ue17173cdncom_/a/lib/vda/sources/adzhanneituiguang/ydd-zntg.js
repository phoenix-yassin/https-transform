...
log1.17173.com/pv?appkey=113&u=" + encodeURIComponent(href) + "&ads=" + adskey + "&uv=" + n
				}
			},
...
a.17173.com/tg/channel/index.html?id=A0011502101" target="_blank" class="instation-adcon-bg" adskey="' + data.mainKey + '"></a>');
				html.push('   <a href="//

itunes.apple.com/cn/app/id727561988?mt=8" target="_blank" class="download android" adskey="' + data.androidKey + '"></a>');
				html.push('    <a href="//

a.17173.com/tg/channel/index.html?id=A0011502101" target="_blank" class="download iphone" adskey="' + data.iphoneKey + '"></a>');
				html.push('    <a class="txm" adskey="' + data.qrKey + '" href="//

a.17173.com/tg/channel/index.html?id=A0011502101" target="_blank"><!--<img src="//

ue3.17173.itc.cn/images/money/2013/zhanneituiguang/txm1220.jpg" alt="" class="avatar" />--></a>');
				html.push('  </div>');
				html.push('</div>');
				this.wrap = $(html.join(''))
			},
			importCss: function() {
				...
				html.push('.instation-adcon{ width:960px; margin:0 auto; height:130px; position:relative; background:url(//

ue.17173cdn.com/a/money/2014/instation-ad/images/moneyinbg0408.jpg) no-repeat left top  }');
				html.push('.instation-adcon .download{ display:block; position:absolute; width:154px; height:41px; /*background:url(//

ue3.17173.itc.cn/images/money/2013/zhanneituiguang/monyinbtn1220.png) no-repeat;*/}');
				html.push('.instation-adcon .android{ top:26px; left:669px; height:40px; background:url(//

ue.17173cdn.com/a/money/2014/instation-ad/images/ios.png) no-repeat;}');
				html.push('.instation-adcon .iphone{ top:71px;left:669px;background:url(//

ue.17173cdn.com/a/money/2014/instation-ad/images/android.png) no-repeat}');
...
ue.17173cdn.com/a/money/2014/instation-ad/images/1.swf',
		handAni: '//

ue.17173cdn.com/a/money/2014/instation-ad/images/2.swf',
		stopHandAni: '',
		down: '//

ue.17173cdn.com/a/money/2014/instation-ad/images/3.swf',
		legAni: '//

ue.17173cdn.com/a/money/2014/instation-ad/images/4.swf',
		stopLegAni: '',
		up: '//

ue.17173cdn.com/a/money/2014/instation-ad/images/5.swf',
		qrCode: '//

ue3.17173.itc.cn/images/money/2013/zhanneituiguang/txm.jpg',
		androidLink: '//
