! function(e) {
	var a = {
		...
		css: function() {
			return '<style type="text/css">.gb-final-ico-arrow-r1{ background: url(//
...
ue.17173cdn.com/a/news/final/2014/img/arrow.gif) no-repeat 0 0; display: inline-block; vertical-align: middle; margin:0 0 0 5px;}#gb_markteing_pro_link{ color:#ff0000;}.gb-final-comm-case-ft-c2{width: 81px; position: absolute; right: 0; top:0;_top:2px; border-left:none}\
