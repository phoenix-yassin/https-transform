...
https.createServer(options, function(request, response) {
  ...
  var ue17173cdncom = request.headers.host;
/**/  if(ue17173cdncom === 'ue.17173cdn.com'){
    realPath = path.join("ue17173cdncom", path.normalize(pathname.replace(/\.\./g, "")));
  }
    //console.log('pathname:' + pathname + ',hostname:' + request.headers.host);
    console.log('hostname:' + request.headers.host + ',realPath:' + realPath);
