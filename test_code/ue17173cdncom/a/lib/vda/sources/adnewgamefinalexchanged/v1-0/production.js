adv.AdBase.extend('AdNewgameFinalExchanged', {
  ...
  buildHtml: function(gameData, data) {
    return  '<div class="fix-sameip">'+
              '<div class="fix-sameip-c1">'+
                ...
                '</div>'+
                '<a href="//newgame.17173.com/game-info-'+data.gameCode+'.html" target="_blank"  class="btn-gload">游戏下载'+
                  '<span class="ewm">'+
                    '<img src="'+data.ewmLink+'" width="120" height="120" alt="" />'+
                  '</span>'+
                '</a>'+
                '<p class="intr">'+
                  '<a href="//newgame.17173.com/game-info-'+data.gameCode+'.html" target="_blank">'+gameData.game_intro+'</a>'+
                '</p>'+
              '</div>'+
            '</div>'+
  ...
  setup: function(data) {
    ...
    this.data = data;
      $.ajax({
        url: '//newgame.internal.17173.com/api-gameDetailInfoJs-'+data.gameCode+'.html?callback=?',
        type: 'GET',
        dataType: 'jsonp',
    ...
    '.fix-sameip-close{position:absolute;top:17px;right:-10px;z-index:10;width:25px;height:25px;background:url(//ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat 0 0}'+
    ...
    '.fix-sameip-c2{position:absolute;z-index:11;top:0;left:0;display:none;padding:5px 7px 35px;width:1pc;background:#ffcd00 url(//ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat -60px bottom;color:#333;font-family:"Microsoft YaHei";line-height:1.3;cursor:pointer}';
