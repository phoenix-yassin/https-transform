!function(e) {
    adv.AdBase.extend("AdNewsFinalMod", {
        ...
        var me = this;
          $('.js-book, .adNewsFinalMod-dialog .js-bmbutton').click(function() {
            ...
            if (Passport.isLoggedIn()) {
              ...
              $('.adNewsFinalMod-dialog').find('input[name=email]').val(me.username);
              me.getMobile()
            } else {
          ...
          $('.adNewsFinalMod-dialog  .jsSubmitUserInfo').click(function() {
      ...
      showRank: function(){
        var me = this;
        $.getScript('//d1.17173.itc.cn/game-top/info/js/'+me.data.gameCode+'.js?', function() {
      ...
      showScore: function() {
        var me = this;
        $.getScript('//d1.17173.itc.cn/newgame/Info/js/'+me.data.gameCode+'.js', function() {
                ...
                <div class="poe-final-c2">\
                  ...
                  <div class="poe-final-box-pec">\
                    <div class="poe-final-bar">\
                      <div class="poe-final-bar-in" style="width:'+ ( 100 - parseInt(el.list[0].stock.split('%')[0],10) ) +'%"></div>\
                    </div>\
                    <span class="poe-final-num">'+( 100 - parseInt(el.list[0].stock.split('%')[0],10) )+'%</span>\
                  </div>\
                </div>\
                <div class="poe-final-c3">\
                  <a href="'+el.list[0].gift_url+'" target="_blank" class="poe-final-bt-hao">抢号</a>\
                  <a href="'+el.list[0].gift_url+'" target="_blank" class="poe-final-bt-hao1">淘号</a>\
                </div>\
              </div>';
              if (el.list[0].stock == '100%') {
