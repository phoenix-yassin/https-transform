...
adv.AdBase.extend('AdZqCommonTip', {
  ...
  setup: function () {
    ...
    this.style= '<style> .zq-tips-box {font-size:12px;background:url(//ue.17173cdn.com/cache/lib/v3/vda/sources/adzqcommontip/img/tips-img-top.png) left top no-repeat;_background:url(//ue.17173cdn.com/cache/lib/v3/vda/sources/adzqcommontip/img/tips-img-top-ie6.png) left top no-repeat; line-height:16px; color:#000; position: absolute; z-index:100;  width:26px; }'+
            '.zq-tip-top{display:block; width:20px; padding-left:6px;}'+
            '.zq-tip-bottom{display:block; background:url(//ue.17173cdn.com/cache/lib/v3/vda/sources/adzqcommontip/img/tips-img-bottom.png) center bottom no-repeat;_background:url(//ue.17173cdn.com/cache/lib/v3/vda/sources/adzqcommontip/img/tips-img-bottom-ie6.png) center bottom no-repeat; width:20px; padding-bottom:6px; overflow:hidden; *zoom:1}'+
