(function() {
  adv.AdMBase.extend('Mad17173ListRecommend', {
    ...
    play: function () {
      ...
      if (opt.ads.length > 0) {
        ...
        adv.util.poll(function(){
          return $container.length > 0 && $container.find('li').length >= 3;
        },function(){
          adv.$.appendStyle(opt.cssString);
          $container.parent('div').addClass('tg-list-index');
          $container.prepend(opt.html);
          $(document.body).trigger('appendHtml',$container);
        }, function() {},5000,500);
