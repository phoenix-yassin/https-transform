...
adv.AdBase.extend('AdYeyouTestlistHot', {
  ...
  play: function () {
    ...
    adv.util.forEach(datas, function (data) {
      ...
      link.attr('href', data.url).after('<img src="//ue1.yeyou.itc.cn/images/www/2012/s-hot-pic.gif" style="vertical-align:middle; margin-bottom:8px; *margin:7px 0 15px 0;" />');
    });
