...
<div style="width: @topWidth@px; height: @topHeight@px; margin: 0px auto; position: relative;">
  ...
  */},
  ...
  showAdMark:function(){
    this.closeBtn.find('img').attr('src', '//ue.17173cdn.com/a/lib/vda/sources/ad17173backgroundtoggle/v1-0/close_ad.png');
    this.data.closeImg = '//ue.17173cdn.com/a/lib/vda/sources/ad17173backgroundtoggle/v1-0/close_ad.png';
    this.data.closeHoverImg = '//ue.17173cdn.com/a/lib/vda/sources/ad17173backgroundtoggle/v1-0/close_ad_hover.png';
  },
  stop: function() {
