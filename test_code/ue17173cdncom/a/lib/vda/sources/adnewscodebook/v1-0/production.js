!function(e) {
    ...
    adv.AdBase.extend("AdNewsCodeBook", {
        ...
        setup: function(data) {
          ...
          .busin{background: #fbfdf9;width: 100%;font: normal 14px/1.5 "Microsoft Yahei"; display:none; margin:12px 0}\
          ...
          .busin-ng-ptlist .busin-cover{position: absolute;width: 70px;height: 52px;top: 0;left: 0;background: url(//ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-cover.png) no-repeat;_display:none;}\
          ...
          .busin .busin-ng-ico-clock{display: inline-block;*zoom:1;*display: inline;vertical-align: middle;background: url(//ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-ico.png) no-repeat;width: 23px;height: 23px;margin-right:10px;}\
          ...
          .busin-dialog .busin-dialog-c1{height:135px;background:url(//ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-dialog-bg.jpg) no-repeat;border-radius: 10px 10px 0 0;padding-top: 85px; }\
          .busin-dialog-c1 .busin-dialog-info{font-size: 16px;color:#ffea00; padding:0 52px; text-align: center}\
          .busin-dialog-c1 .busin-dialog-tt{background: url(//ue.17173cdn.com/a/lib/vda/sources/adnewgamecodebook/img/busin-ico.png) no-repeat -30px 3px;padding-left: 20px;display: inline-block;*display: inline;margin:0 15px;}\
          ...
          .busin-dialog-c2{padding-bottom: 10px;min-height: 280px;}\
         ...
         .busin p{ padding:0;text-indent:0}\
      </style>'
      ...
      showNum:function() {
          var me = this;
          $.getScript('//d1.17173.itc.cn/hao/giftlist/js/'+me.data.gameCode+'.js', function() {
      ...
      getMobile: function() {
        var me = this;
        $.ajax({
          url: '//passport.17173.com/site/getMobile?callback=abc',
          type: 'GET',
          dataType: 'jsonp',
          jsonpCallback:'abc',
      ...
      sendInfo: function(data) {
          $.ajax({
            url: '//hao.17173.com/api/Schegame?',
            type: 'GET',
            dataType: 'jsonp',
            data: data,
            success: function(data) {
