...
adv.AdBase.extend('AdFlashIndexDoubleFloat', {
  ...
  setup: function() {
    ...
    '<img src="//ue.17173cdn.com/a/lib/vda/sources/adflashindexdoublefloat/v1-1/close.png"  style="position:absolute; bottom:0; left:0; width:12px; height:12px ; z-index:100; cursor:pointer; background:#fff; " class="doublefloatclose" />'
    ...
    this.html +='<a href="javascript:;" style="position:absolute; bottom:0; right:0; width:12px; height:12px ; z-index:10; background:#fff; " class="doublefloatclose" ><img src="//ue.17173cdn.com/a/lib/vda/sources/adflashindexdoublefloat/v1-1/close.png" alt="" /></a></div>'+
