(function() {
  adv.AdMBase.extend('Mad17173NewsGallery', {
    ...
    play: function () {
      ...
      if (opt.ads.length > 0) {
        ...
        adv.util.poll(function(){
          ...
          ued.focusSlide.slidePrev();
          $('.'+opt.advid).not(ued.focusSlide.wrapper.parents('.'+opt.advid)).find('ul.swiper-wrapper').prepend(opt.html);
          self._showCount();
        },function(){
        },7000,500);
