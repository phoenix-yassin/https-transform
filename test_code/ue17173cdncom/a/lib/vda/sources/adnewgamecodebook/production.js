!function(e) {
    adv.AdBase.extend("AdNewgameCodeBook", {
        ...
        me.dialog = '<div class="busin-dialog adNewgameCodeBook-dialog" style="display:none;">\
          ...
          <div class="busin-in">\
              <div class="busin-c1">\
                  <h2 class="busin-hd-tit"><i class="busin-ng-ico-clock"></i>\u8ddd\u79bb\u5f00\u6d4b\u65f6\u95f4\u8fd8\u6709\uff1a<span class="busin-orange" id="kcDate"></span></h2>\
                  ...
                  me.html.push('<div class="busin-c2">\
      ...
      sendInfo: function(data) {
          $.ajax({
            url: '//hao.17173.com/api/Schegame?callback=?',
            type: 'GET',
            dataType: 'jsonp',
            data: data,
            success: function(data) {
