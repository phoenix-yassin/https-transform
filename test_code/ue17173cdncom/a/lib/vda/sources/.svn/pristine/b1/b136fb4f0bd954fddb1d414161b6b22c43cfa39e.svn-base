adv.AdBase.extend('AdNewgameFinalExchanged', {
  ...
  setup: function(data) {
    ...
    this.data = data;
      $.ajax({
        url: 'http://test.newgame.17173.com/api-gameDetailInfoJs-'+data.gameCode+'.html?callback=?',
        type: 'GET',
        dataType: 'jsonp',
    ...
    '.fix-sameip-close{position:absolute;top:-10px;right:-10px;z-index:10;width:25px;height:25px;background:url(http://ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat 0 0}'+
    ...
    '.fix-sameip-c2{position:absolute;z-index:11;top:0;right:0;display:none;padding:5px 7px 35px;width:1pc;background:#ffcd00 url(http://ue1.17173cdn.com/a/newgame/index/2016/fix-sameip/img/fix-sameip-sp.png) no-repeat -60px bottom;color:#333;font-family:"Microsoft YaHei";line-height:1.3;cursor:pointer}';
