(function($){
  adv.AdBase.extend('AdBBSGamePayRecommend', {
    ...
    setup: function(data) {
      ...
      var tmpl = '@for(var i = 0; i < 3; i++){<tbody><tr><td class="icn"><img src="http://ue.17173cdn.com/a/bbs/index/2016/img/bbs-ico-tg.png"></td><th class="common"><a target="_blank" href="@json[i].href" style="font-weight: bold;" class="xst tg_link_@i">@json[i].title</a><span style="font-size:14px; color:#aaa; margin-left:2em;">推广</span></th><td class="by by-co1"><cite><a target="_blank" href="@json[i].game_url">@json[i].game_name</a></cite><em><span>@json[i].date</span></em></td><td class="num num-co1"><a href="javascript:;" class="xi2">0</a><em> / 0</em></td><td class="by by-co2"><em>1&nbsp;秒前</span></a></em><cite>by:<a href="@json[i].game_url" target="_blank">@json[i].game_name</a></cite></td></tr></tbody>}';
