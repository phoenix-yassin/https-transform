...
'.recd-mhxy{overflow:hidden;*zoom:1;*float: left;width: 297px; font-family: "Microsoft Yahei"; font-size: 12px;background: #f4f8fc; border: 1px solid #dddddd; border-left: 0; }'+
'.recd-mhxy a{color:#a19b8f;text-decoration: none;}'+
'.recd-mhxy a:hover{ text-decoration: underline;}'+
'.recd-mhxy img{border: none; display: block;}'+
...
'.recd-mhxy-pt .text{overflow: hidden;*zoom:1; *float: left;*width: 167px;}'+
...
'.recd-mhxy-new .item{line-height:26px; *overflow: hidden; *float: left; *width: 100%;background: url(http://ue1.17173cdn.com/a/money/2016/img/ico.png) no-repeat 0 center;padding-left: 13px;}'+
...
'.recd-mhxy-new .item .tit-con{display: block;width: 99.8%; overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}</style>';
  ...
  play: function() {
   ...
   if($('.app17173-code').length >0) {
      ...
      $(me.html).insertAfter('.app17173-code')
