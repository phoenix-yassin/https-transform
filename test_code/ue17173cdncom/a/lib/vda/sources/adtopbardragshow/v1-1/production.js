...
(function() {
  ...
  adv.AdBase.extend('AdTopBarDragShow', {
    ...
    setup: function(data) {
      ...
      .gb-tg-pull .gb-tg-pull-c2{ position: absolute; left:50%; /* bottom:-111px;top:0px;*/  margin-left:560px; z-index:100}\
      ...
      .gb-tg-pull .gb-tg-pull-c2 .gb-tg-pull-back i{ display: block; width:42px; height:22px; position:absolute; left:50%; top:50%; margin:-11px 0 0 -21px; background: url(//ue.17173cdn.com/a/module/tg-pull/2016/img/gb-tg-pull-arrow.png) no-repeat;}\
    </style>';
      ...
      adv.util.poll(function(){
       return $('#ue-topbar').length;
        ...
        $('.adtopbardragshowbar').click(function(event) {
          ...
          $('.adtopbardragshowcon a').click(function(){
          ...
          $('.adtopbardragshowbar a').click(function(){
              window._jc_ping = window._jc_ping || [];
                _jc_ping.push([
                  '_trackBlockClick',
                   'Enaayq',
