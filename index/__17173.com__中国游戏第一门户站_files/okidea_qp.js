(function(){
	...
	var htt =  'https:' == document.location.protocol ? '' : 'http:',
		...
		okideaad_id = "38432",//广告位id
		okideaad_date = "201609/01-161",
		okhref_17173 = htt+"//Cvda.17173.com/click?media_code=17173&ad_code=171731000&resource_code=1000&order_code=1010114",//173的监测链接
	...
	/*oi_qp_time_area = getCookie("oi_lastPlayTime"+OkIdea_qp1.oi_qp_id);
	if((oi_qp_time_area==null)||(oi_qp_time_area!=oi_now_timeArea)){
		oi_qp_time_area=oi_now_timeArea;
		SetCookie("oi_lastPlayTime"+OkIdea_qp1.oi_qp_id,oi_qp_time_area);
		oi_qp_played=1;
		SetCookie("oi_qp_played"+OkIdea_qp1.oi_qp_id,oi_qp_played);
	}else if (oi_qp_time_area==oi_now_timeArea){
		oi_qp_played=getCookie("oi_qp_played"+OkIdea_qp1.oi_qp_id);
	...
	function OkIdea_qp_p1(display){
		...
		oi_qp1_video_in='<div id="OkIdea_qp" class="OkIdea_qp" style="position:absolute;width:'+OkIdea_qp1.flash_w+'px;height:'+OkIdea_qp1.flash_h+'px;margin-left:'+(-OkIdea_qp1.flash_w/2)+'px;top:200px; left:50%; z-index:99998;display:'+p1_control+';"><a class="OkIdea_qp_href" href="'+OkIdea_qp1.oi_url+'" target="_blank" title="" style="display:inline-block;position:absolute;left:0px;top:0px; width:360px;height:400px;z-index:99999;background:#000;filter:alpha(opacity=1);opacity:0.01;"></a><a class="OkIdea_qp_href" href="'+OkIdea_qp1.oi_url+'" target="_blank" title="" style="display:inline-block;position:absolute;right:0px;top:0px; width:40px;height:350px;z-index:99999;background:#000;filter:alpha(opacity=1);opacity:0.01;"></a><a href="javascript:;" onclick="_aoqi_dtqp.close()" style="display:inline-block;position:absolute;right:0px;bottom:0px; width:40px;height:50px;z-index:99999;background:#000;filter:alpha(opacity=1);opacity:0.01;" ></a><embed width="'+OkIdea_qp1.flash_w+'" height="'+OkIdea_qp1.flash_h+'" src="'+OkIdea_qp1.flash_src+'" quality="autohigh" wmode="transparent" type="application/x-shockwave-flash" plugspace="'+htt+'//www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" allowscriptaccess="always"></div>';
